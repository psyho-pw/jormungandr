...
export type SlackActionArgs = SlackActionMiddlewareArgs &
    AllMiddlewareArgs & {columnType: CoretimeColumn}

export type SlackReactionAddEventArgs = SlackEventMiddlewareArgs<'reaction_added'> &
    AllMiddlewareArgs
export type SlackReactionRemoveEventArgs = SlackEventMiddlewareArgs<'reaction_removed'> &
    AllMiddlewareArgs
